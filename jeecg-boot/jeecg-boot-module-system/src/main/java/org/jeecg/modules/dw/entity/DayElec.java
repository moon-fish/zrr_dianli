...
@ApiModel(value="day_elec对象", description="日用电量")
public class DayElec {
...
//	@Excel(name = "23:45:00", width = 15)
	...
	/**日申报电量*/
	@Excel(name = "日申报电量", width = 15)
    @ApiModelProperty(value = "日申报电量")
	private java.math.BigDecimal dayElec;
	/**日申报状态*/
//	@Excel(name = "日申报状态", width = 15)
    @ApiModelProperty(value = "日申报状态")
	private java.math.BigDecimal dayStatus;
    /**备注*/
