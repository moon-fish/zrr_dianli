 ...
 */
@Data
@TableName("user_purchase_contract_b")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="user_purchase_contract_b对象", description="电力用户购电合同")
public class UserPurchaseContractB implements Serializable {
	...
	/**分月电量*/
	@Excel(name = "分月电量", width = 15)
    @ApiModelProperty(value = "分月电量")
    private java.lang.String monthElectricity;
	/**联系人姓名*/
	...
	/**售电价*/
	@Excel(name = "售电价", width = 15)
    @ApiModelProperty(value = "售电价")
