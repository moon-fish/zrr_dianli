 ...
 */
@Data
@TableName("account_use_info")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="account_use_info对象", description="存放对比后的数据")
public class AccountUseInfo {
...
//	@Excel(name = "是否可用", width = 15)
	...
	/**对比月份*/
//	@Excel(name = "对比月份", width = 15)
    @ApiModelProperty(value = "对比月份")
	private java.lang.String compareMonth;
