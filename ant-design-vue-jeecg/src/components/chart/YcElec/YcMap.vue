<template>
  <div>
    <v-chart :forceFit="true" :height="350" :padding="padding" :scale="scale">
      <v-tooltip :showTitle="false" />
      <v-view :data="geoData" :scale="scale">
        <v-polygon position="longitude*latitude" color="#3366cc" :label="label" />
      </v-view>
      <v-view :data="data">
        <v-heatmap
...
<script>
  ...
  import yunchengshi from '@/assets/yunchengshi.json'
