<template>
  <div>
    <v-chart :forceFit="true" :height="height" :data="data" :scale="scale">
      ...
      <v-bar position="time*waiting2" color="#3182bd" />
...
<script>
  const data = [
    { time: '10:10', call: 7, waiting: 2, people: 2,waiting2: 3, },
    { time: '10:15', call: 2, waiting: 6, people: 3,waiting2: 3, },
    { time: '10:20', call: 13, waiting: 2, people: 5,waiting2: 3, },
    { time: '10:25', call: 9, waiting: 9, people: 1,waiting2: 3, },
