...
<!--      </div>-->
      ...
      <div class="box-center">
        ...
        <div class="center-center">
          <div class="data">
            <div class="title-box">
              <span style="color: #ffffff;margin-left: 20px;font-size: 14px;">采集率</span>
            </div>
            <div style="width: 100%;height: 33%;">
              <dash-chart-demo></dash-chart-demo>
<!--                  <shui-di></shui-di>-->
            </div>
            <div style="width: 100%;height: 33%;">
              <dash-chart-demo></dash-chart-demo>
        ...
        <div class="center-bottom">
          <div class="title-box">
            <span data-dataType="income">收入数据</span>
          </div>
          <div class="city-data">
            <div class="city-box">
              <cai-ji-lv></cai-ji-lv>
      ...
      <div class="pop-up">
        ...
        <div class="set-div">
          ...
          <div class="set-box">
            ...
            <button id="mineusT" style="display:none;"></button>
          </div>
          <div class="set-box">
            <label>负责人</label>
            <input type="text" value="">
...
<script>
    import CaiJiLv from "../components/chart/YcElec/CaiJiLv";
    import RiXianSun from "../components/chart/YcElec/RiXianSun";
    import YcMap from "../components/chart/YcElec/YcMap";
    import DashChartDemoChange from "../components/chart/YcElec/DashChartDemoChange";
    import DashChartDemo from "../components/chart/DashChartDemo";
    import ShuiDi from "../components/chart/YcElec/ShuiDi";
    import huaban from "../components/chart/YcElec/huaban";
