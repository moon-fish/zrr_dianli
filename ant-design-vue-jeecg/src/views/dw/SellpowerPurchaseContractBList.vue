<template>
  <a-card :bordered="false">
    ...
    <sellpowerPurchaseContractB-modal ref="modalForm" @ok="modalFormOk"></sellpowerPurchaseContractB-modal>
  </a-card>
</template>
...
<script>
  ...
  export default {
    name: "SellpowerPurchaseContractBList",
