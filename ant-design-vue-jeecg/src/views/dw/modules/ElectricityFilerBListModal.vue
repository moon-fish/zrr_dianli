...
<!--      <span v-html="record.msgContent" class="article-content"></span>-->
      <electricity-filer-b-message></electricity-filer-b-message>
    </a-card>
  </a-modal>
</template>

<script>
  import ElectricityFilerBMessage from "../ElectricityFilerBMessage";
  export default {
    name: "ElectricityFilerBListModal",
    components: {
      ElectricityFilerBMessage,
    },
    data () {
      return {
        title:"通知消息",
