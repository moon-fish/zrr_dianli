  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'contractName','userName','transactionType','beginDate','endDate','purchaseElectricity','depoaitBank','name','phone','officePhone','duty','depoaitAccount','contractFile'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'contractName','userName','transactionType','beginDate','endDate','purchaseElectricity','depoaitBank','name','phone','officePhone','duty','depoaitAccount','contractFile'))
      }
