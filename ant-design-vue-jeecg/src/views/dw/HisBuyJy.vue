                ...
                <a-form layout="inline">
                  ...
                  <a-row>
                    <a-col :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                      ...
                      <line-chart-multid title="售/购电量(kwh)" :height="height" :dataSource="lineData" :fields="lineFields"></line-chart-multid>
                    </a-col>
                    <a-col :xl="12" :lg="12" :md="12" :sm="24" :xs="24">
                      <div style="text-align: center;font-weight: bold;font-size: large;">{{this.text}}</div>
                      <line-chart-multid title="售/购成本" :height="height" :dataSource="lineData2" :fields="lineFields2"></line-chart-multid>
                    </a-col>
                  </a-row>
  ...
  export default {
    ...
    data () {
      return {
        ...
        height: 254,
        lineData: [
          { type: '2020-01',  用户001购电量: 76.3, 用户001售电量: 24.5,用户002购电量: 65.5, 用户002售电量: 67,用户003购电量: 26, 用户003售电量: 62,用户004购电量: 54, 用户004售电量: 56.2 },
          { type: '2020-02',  用户001购电量: 42.5, 用户001售电量: 45.2,用户002购电量: 34, 用户002售电量: 52,用户003购电量: 63, 用户003售电量: 53,用户004购电量: 54, 用户004售电量: 65 },
          { type: '2020-03',  用户001购电量: 34.6, 用户001售电量: 56.9,用户002购电量: 26, 用户002售电量: 64,用户003购电量: 35, 用户003售电量: 73,用户004购电量: 65, 用户004售电量: 23 },
          { type: '2020-04',  用户001购电量: 75.2, 用户001售电量: 22.8,用户002购电量: 36, 用户002售电量: 24,用户003购电量: 26, 用户003售电量: 35,用户004购电量: 24, 用户004售电量: 43 },
        ],
        lineFields:['用户001购电量','用户001售电量','用户002购电量','用户002售电量','用户003购电量','用户003售电量','用户004购电量','用户004售电量',],
        lineData2: [
          { type: '2020-01',  用户001购电成本: 76.3, 用户001售电成本: 24.5,用户002购电成本: 65.5, 用户002售电成本: 67},
          { type: '2020-02',  用户001购电成本: 42.5, 用户001售电成本: 45.2,用户002购电成本: 34, 用户002售电成本: 52 },
          { type: '2020-03',  用户001购电成本: 34.6, 用户001售电成本: 56.9,用户002购电成本: 26, 用户002售电成本: 64 },
          { type: '2020-04',  用户001购电成本: 75.2, 用户001售电成本: 22.8,用户002购电成本: 36, 用户002售电成本: 24 },
        ],
        lineFields2:['用户001购电成本','用户001售电成本','用户002购电成本','用户002售电成本'],
        checkType:'current',
        text: '',
        searchValue: '',
